...
local function main()
    if game.PlaceId == 108533757090220 then
        ...
        while true do
            ...
            if(tonumber(Wins.Text) >= 25 and workspace.Map.BaseHP.CFrame == CFrame.new(-335.381012, 68.4682846, -272.472839, 0, 0, 1, 0, 1, -0, -1, 0, 0)) or (workspace.Map.BaseHP.CFrame == CFrame.new(-335.381012, 68.4682846, -272.472839, 0, 0, 1, 0, 1, -0, -1, 0, 0) and tonumber(Wins.Text) < 25 and tonumber(Seed) < 15000 and (not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Laser Plant") or not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Tomato") or not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Farmer"))) then
                PlayLose()
